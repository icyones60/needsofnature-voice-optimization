...
public final class StageVoiceModMenu implements ModMenuApi {
    ...
    private static Screen createConfigScreen(Screen parent) {
        ...
        category.addEntry(entries.startIntSlider(Text.literal("语音音量"), volumePercent, 0, 500)
        ...
        category.addEntry(packSelector(
                entries,
                "high 音频包",
                config.highPack(),
                VoicePack.DEFAULT,
    ...
    private static me.shedaniel.clothconfig2.api.AbstractConfigListEntry packSelector(
